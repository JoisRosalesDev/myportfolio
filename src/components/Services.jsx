  ...
  return (
    <section id="Services" className="relative bg-bunker-50 pt-24 pb-16">
      ...
      <div className="container mx-auto p-4 sm:px-6 max-w-4xl">
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-center text-bunker-50 italic mb-8 md:mb-12 lg:mb-16">
          Services
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-auto md:grid-rows-5 gap-4 text-bunker-50">
          ...
          <div className="col-span-1 md:col-span-2 row-span-1 md:row-span-3 bg-bunker-800 rounded-2xl p-4 md:p-6 flex flex-col transition hover:bg-bunker-700 hover:scale-105">
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl lg:text-2xl font-semibold text-bunker-50 mb-2 md:mb-4">
              Web development
            </h3>
            <p className="text-xs sm:text-sm md:text-base lg:text-lg text-bunker-50 flex-grow">
          ...
          <div className="col-span-1 md:col-span-2 md:col-start-3 row-span-1 md:row-span-2 bg-bunker-800 rounded-2xl p-4 md:p-6 flex flex-col transition-all hover:shadow-lg hover:bg-bunker-700 hover:scale-105">
            <div className="mb-3 md:mb-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
          ...
          <div className="col-span-1 md:col-span-2 md:col-start-1 md:row-start-4 row-span-1 md:row-span-2 bg-bunker-800 rounded-2xl p-4 md:p-6 flex flex-col transition-all hover:shadow-lg hover:bg-bunker-700 hover:scale-105">
            <div className="mb-3 md:mb-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
          ...
          <div className="col-span-1 md:col-span-2 md:col-start-3 md:row-start-3 row-span-1 md:row-span-3 bg-bunker-800 rounded-2xl p-4 md:p-6 flex flex-col transition-all hover:shadow-lg hover:bg-bunker-700 hover:scale-105">
            <div className="mb-3 md:mb-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="26"
